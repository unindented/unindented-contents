...
I've been playing with a few scaling algorithms in the [2dimagefilter](https://code.google.com/p/2dimagefilter/) project. They produce quite impressive results when fed pixel art, and the fact that emulators are able to run them in real time is just mindboggling.
