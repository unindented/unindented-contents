...
Have you ever found yourself needing trigonometric functions like sines, cosines and tangents when writing your [Sass](https://sass-lang.com/) stylesheets? Ok, probably not, but the day may come, and you'll be glad you read this.
...
If I had paid more attention in [numerical analysis](https://en.wikipedia.org/wiki/Numerical_analysis) class, I may have been able to tell you everything about the [CORDIC algorithm](https://en.wikipedia.org/wiki/Cordic), the [Chebyshev polynomials](https://en.wikipedia.org/wiki/Chebyshev_polynomial), or the [Remez algorithm](https://en.wikipedia.org/wiki/Remez_algorithm). But I didn't, so the best I _can_ do is to copy and paste the [Taylor expansions](https://en.wikipedia.org/wiki/Taylor_series) for the sine and cosine functions:
...
Denominators $(2n+1)!$ and $(2n)!$ require us to implement a _factorial_ function, but this is even more straightforward:
...
If you are using [Compass](https://github.com/Compass/compass) you already have plenty of math helpers at your disposal, so you don't need to write your own.
